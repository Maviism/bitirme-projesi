...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-94x&qew39v!vkhf_t=4=%mtbbboa4)^alny^zkse%!t$#-%7xc')
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DATABASE_NAME', 'career_db'),
...
DEEPGRAM_API_KEY = os.environ.get('DEEPGRAM_API_KEY', '91ced55ae66c593f832bcb25d3948a71b9d961f6')
